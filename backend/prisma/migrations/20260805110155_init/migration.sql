...
-- CreateEnum
CREATE TYPE "InventoryReason" AS ENUM ('RESTOCK', 'ORDER_PLACED', 'ORDER_CANCELLED', 'RETURN', 'MANUAL_ADJUSTMENT');

-- CreateEnum
CREATE TYPE "SeoEntityType" AS ENUM ('PRODUCT', 'CATEGORY', 'PAGE');
